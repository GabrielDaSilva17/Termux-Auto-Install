...
Este repositório oferece um script de automação de elite para o **Termux**. Ele transforma seu ambiente básico em uma estação de trabalho poderosa, integrando ferramentas de desenvolvimento, redes, servidores e utilitários gráficos.
...
* **Download:** **yt-dlp** (sucesor do youtube-dl) e Speedtest-cli.
...
* **Visual:** Neofetch, Cmatrix, Figlet, Cowsay, Fortune e SL.
